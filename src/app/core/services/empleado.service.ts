...
export class EmpleadoService {
  ...
  buscarEmpleados(filtros: any): Observable<Empleado[]> {
    ...
    return this.http.get<Empleado[]>(`${this.apiUrl}/filtros`, { 
      params, 
      headers: this.getHeaders() 
    });
  }
  ...
  validarCi(ci: string): Observable<{existe: boolean}> {
    return this.http.get<{existe: boolean}>(`${this.apiUrl}/validar/ci/${ci}`, { 
      headers: this.getHeaders() 
    });
  }
  ...
  validarCorreo(correo: string): Observable<{existe: boolean}> {
    return this.http.get<{existe: boolean}>(`${this.apiUrl}/validar/correo/${correo}`, { 
      headers: this.getHeaders() 
    });
  }
