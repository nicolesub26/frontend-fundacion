...
export class VoluntarioService {
  ...
  listar(estado?: EstadoBinario): Observable<Voluntario[]> {
    if (estado === 0 || estado === 1) {
      return this.http
        .get<any[]>(`${this.BASE_URL}/estado/${estado}`, { headers: this.getHeaders() })
        .pipe(map(this.adaptMany), catchError(this.handleError));
    }
    return this.http
      .get<any[]>(`${this.BASE_URL}`, { headers: this.getHeaders() })
      .pipe(map(this.adaptMany), catchError(this.handleError));
  }
  ...
  crear(payload: CrearVoluntarioDto, conUsuario = true): Observable<Voluntario> {
    ...
    return this.http
      .post<any>(`${this.BASE_URL}`, payload, { headers: this.getHeaders(), params })
      .pipe(
  ...
  activar(id: number): Observable<Voluntario> {
    return this.http
      .put<any>(`${this.BASE_URL}/${id}/activar`, {}, { headers: this.getHeaders() })
      .pipe(map(this.adaptOne), catchError(this.handleError));
  }
  ...
  desactivar(id: number): Observable<Voluntario> {
    return this.http
      .put<any>(`${this.BASE_URL}/${id}/desactivar`, {}, { headers: this.getHeaders() })
      .pipe(map(this.adaptOne), catchError(this.handleError));
  }
  ...
  cambiarEstado(id: number, nuevoEstado: EstadoBinario): Observable<Voluntario> {
    return this.http
      .put<any>(`${this.BASE_URL}/${id}/estado/${nuevoEstado}`, {}, { headers: this.getHeaders() })
      .pipe(map(this.adaptOne), catchError(this.handleError));
  }
  ...
  listarPorDisponibilidad(disp: Disponibilidad): Observable<Voluntario[]> {
    return this.http
      .get<any[]>(`${this.BASE_URL}/disponibilidad/${encodeURIComponent(disp)}`, { headers: this.getHeaders() })
      .pipe(map(this.adaptMany), catchError(this.handleError));
  }
  ...
  listarPorEspecialidad(q: string): Observable<Voluntario[]> {
    ...
    return this.http
      .get<any[]>(`${this.BASE_URL}/especialidad`, { headers: this.getHeaders(), params })
      .pipe(map(this.adaptMany), catchError(this.handleError));
  }
  ...
  obtenerPorUsuario(login: string): Observable<Voluntario> {
    return this.http
      .get<any>(`${this.BASE_URL}/usuario/${encodeURIComponent(login)}`, { headers: this.getHeaders() })
      .pipe(map(this.adaptOne), catchError(this.handleError));
  }
  ...
  validarCi(ci: string): Observable<boolean> {
    return this.http
      .get<any>(`${this.BASE_URL}/validar/ci/${encodeURIComponent(ci)}`, { headers: this.getHeaders() })
  ...
  validarEmail(email: string): Observable<boolean> {
    return this.http
      .get<any>(`${this.BASE_URL}/validar/email/${encodeURIComponent(email)}`, { headers: this.getHeaders() })
      .pipe(map(r => !!r?.existe), catchError(this.handleError));
  }
  ...
  validarTelefono(tel: string): Observable<boolean> {
    return this.http
      .get<any>(`${this.BASE_URL}/validar/telefono/${encodeURIComponent(tel)}`, { headers: this.getHeaders() })
      .pipe(map(r => !!r?.existe), catchError(this.handleError));
  }
  ...
  estadisticas(): Observable<VoluntarioStats> {
    return this.http
      .get<VoluntarioStats>(`${this.BASE_URL}/estadisticas`, { headers: this.getHeaders() })
      .pipe(catchError(this.handleError));
  }
